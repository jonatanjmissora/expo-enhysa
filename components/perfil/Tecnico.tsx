...
async function load() {
	...
	if (loading || tecnico === undefined) {
		return (
			<View style={{ backgroundColor: "#152436ff", flex: 1, alignItems: "center", justifyContent: "center" }}>
	...
	if (!tecnico) {
		return (
			<View style={{ backgroundColor: "#152436ff", flex: 1, alignItems: "center", justifyContent: "center", gap: 12 }}>
				<Text style={{ color: "#94a3b8" }}>Aún no tenés un técnico cargado.</Text>
	...
	return (
		<View style={{ backgroundColor: "#152436ff", flex: 1, padding: 16, gap: 8 }}>
